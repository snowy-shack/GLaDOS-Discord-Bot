 ...
 */
export function embed(body, footer, title, color = colors.Primary, fields = []) {
 ...
 */
export function message(body, footer, title, color = colors.Primary, hidden, fields = []) {
    return { embeds: [ embed(body, footer, title, color) ], ephemeral: hidden };
}